          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              ...
              <ul class="list-group list-group-unbordered">
                ...
                <li class="list-group-item">
                  <b>Pembina</b> <div class="pull-right"><a href="/simon/index.php?page=pembinadetails&id=<?php echo $row['id_user_pembina']; ?>"><?php echo $row['nama_pembina']; ?></a>&nbsp;&nbsp;&nbsp;<span class="btn btn-secondary" href=""><i class="fa fa-user-o fa-lg"></i></span></div>
                </li> 
                <li class="list-group-item">
